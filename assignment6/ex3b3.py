...
def compute_dual_pca(data):
    ...
    # Transform back 1
    eigenvectors_4074_0 = np.copy(eigenvectors)
    eigenvectors_4074_0[4074,:] = 0

    reconstructed_data = np.dot(projected_image, eigenvectors_4074_0.T) + mean

    image1 = reconstructed_data.reshape((96, 84))

    # Transform back 2
    eigenvectors_2_0 = np.copy(eigenvectors)
    eigenvectors_2_0[1,:] = 0

    reconstructed_data2 = np.dot(projected_image, eigenvectors_2_0.T) + mean
    image2 = reconstructed_data2.reshape((96, 84))
